...
install_ogracdb()
{
    ...
    # tar -zxvf ${code_path}/output/bin/oGRAC-DATABASE-CENTOS-64bit/oGRAC-RUN-CENTOS-64bit.tar.gz -C ${OGDB_HOME_1}
    # cp -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit/add-ons     ${OGDB_HOME_1}
    # cp -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit/bin         ${OGDB_HOME_1}
    # cp -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit/lib         ${OGDB_HOME_1}
    # cp -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit/admin       ${OGDB_HOME_1}
    # cp -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit/package.xml ${OGDB_HOME_1}
    # rm -rf ${OGDB_HOME_1}/oGRAC-RUN-CENTOS-64bit
