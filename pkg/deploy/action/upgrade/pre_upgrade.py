...
ACTION_DIR = os.path.dirname(CUR_PATH)
...
NEW_CONFIG_PATH = str(Path(f'{ACTION_DIR}/config_params.json'))
SOURCE_CONFIG_PATH = str(Path('/opt/ograc/action/config_params.json'))
NEW_FILE_CONFIG_PATH = str(Path(f'{ACTION_DIR}/config_params_file.json'))
...
NEW_DEPLOY_CONFIG = str(Path(f"{ACTION_DIR}/deploy_param.json"))
