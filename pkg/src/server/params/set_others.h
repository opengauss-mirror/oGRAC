...
status_t sql_verify_als_rbp_trans_type(void *se, void *lex, void *def);
...
status_t sql_notify_als_rbp_rcy_check(void *se, void *item, char *value);
status_t sql_notify_als_rbp_ip(void *se, void *item, char *value);
