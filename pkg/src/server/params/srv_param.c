...
config_item_t g_parameters[] = {
    ...
    { "_ENABLE_REMOTE_DISTRIBUTE_LOCK", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN",
    ...
    { "_ENABLE_UBSMEM", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
