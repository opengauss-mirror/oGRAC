...
config_item_t g_parameters[] = {
    ...
    ************************************************************************* */
...
#else
    { "_ENCRYPTION_ITERATION", OG_TRUE, ATTR_NONE, "1000000", NULL, NULL, "-", "[10000000,20000000]", "OG_TYPE_INTEGER", NULL,
      PARAM_ENCRYPTION_ITER, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_encrypt_iteration,
      sql_notify_als_encrypt_iteration, sql_notify_als_encrypt_iteration, NULL },
#endif
    ...
    { "ENABLE_IDX_KEY_LEN_CHECK", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      ...
      sql_notify_als_bool, NULL },
    { "CBO", OG_TRUE, ATTR_NONE, "ON", NULL, NULL, "-", "OFF,ON", "OG_TYPE_VARCHAR", NULL, PARAM_CBO,
    ...
    { "CBO_DYNAMIC_SAMPLING", OG_TRUE, ATTR_NONE, "1", NULL, NULL, "-", "[0,9]", "OG_TYPE_INTEGER", NULL,
    ...
    { "ENABLE_SYS_CRC_CHECK", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "GS_TYPE_BOOLEAN", NULL,
