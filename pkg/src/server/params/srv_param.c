...
config_item_t g_parameters[] = {
    ...
    ************************************************************************* */
    ...
    { "GBP_IP", OG_TRUE, ATTR_NONE, "127.0.0.1", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL, PARAM_GBP_IP,
      EFFECT_REBOOT, CFG_INS, sql_verify_als_gbp_ip, NULL, NULL, NULL },
    { "GBP_PORT", OG_TRUE, ATTR_NONE, "2611", NULL, NULL, "-", "[1024,65535]", "OG_TYPE_INTEGER", NULL,
      PARAM_GBP_PORT, EFFECT_REBOOT, CFG_INS, sql_verify_als_gbp_port, NULL, NULL, NULL },
    { "LOCAL_GBP_HOST", OG_TRUE, ATTR_NONE, "127.0.0.1", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL,
      PARAM_LOCAL_GBP_HOST, EFFECT_REBOOT, CFG_INS, sql_verify_als_local_gbp_host, NULL, NULL, NULL },
    { "USE_GBP", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_USE_GBP, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_use_gbp, sql_notify_als_bool,
      NULL },
    { "GBP_FOR_RECOVERY", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_GBP_FOR_RECOVERY, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    { "GBP_RT_ANALYSIS", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_GBP_RT_ANALYSIS, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    { "GBP_RT_PARSE_WORKERS", OG_TRUE, ATTR_NONE, "2", NULL, NULL, "-", "[1,8]", "OG_TYPE_INTEGER", NULL,
      PARAM_GBP_RT_PARSE_WORKERS, EFFECT_REBOOT, CFG_INS, sql_verify_als_uint32, NULL, NULL, NULL },
    { "GBP_RT_PAGE_OWNER_WORKERS", OG_TRUE, ATTR_NONE, "4", NULL, NULL, "-", "[1,8]", "OG_TYPE_INTEGER", NULL,
      PARAM_GBP_RT_PAGE_OWNER_WORKERS, EFFECT_REBOOT, CFG_INS, sql_verify_als_uint32, NULL, NULL, NULL },
    { "GBP_ASSEMBLE_MAX_SCAN", OG_TRUE, ATTR_NONE, "300", NULL, NULL, "-", "[100, 1000000]", "OG_TYPE_INTEGER", NULL,
      PARAM_GBP_ASSEMBLE_MAX_SCAN, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_gbp_assemble_max_scan,
      sql_notify_als_gbp_assemble_max_scan, NULL, NULL },
    // EXPLAIN
