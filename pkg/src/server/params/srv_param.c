...
config_item_t g_parameters[] = {
    ...
    { "_ENABLE_REMOTE_DISTRIBUTE_LOCK", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN",
      NULL, PARAM__ENABLE_REMOTE_DISTRIBUTE_LOCK, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool,
      sql_notify_als_enable_remote_distribute_lock, sql_notify_als_bool, NULL },
    { "_ENABLE_UBSMEM", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM__ENABLE_UBSMEM, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_enable_ubsmem,
      sql_notify_als_bool, NULL },
    { "_UB_PAGE_HOT_THRESHOLD", OG_TRUE, ATTR_NONE, "100", NULL, NULL, "-", "[1,10000]", "OG_TYPE_INTEGER", NULL,
      PARAM__UB_PAGE_HOT_THRESHOLD, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_ub_page_hot_threshold,
      NULL, NULL, NULL },
    ...
    ************************************************************************* */
    ...
    { "ARCHIVE_FORMAT", OG_TRUE, ATTR_NONE, "arch_%t_%r_%s.arc", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL,
      ...
      "LOG_ARCHIVE_FORMAT" },
    { "ARCHIVE_FORMAT_WITH_LSN", OG_TRUE, ATTR_NONE, "arch_%t_%r_%s_%d_%e.arc", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR",
      NULL, PARAM_LOG_ARCHIVE_FORMAT_WITH_LSN, EFFECT_REBOOT, CFG_INS, sql_verify_als_comm,
    ...
    { "CHECKPOINT_GROUP_SIZE", OG_TRUE, ATTR_NONE, "4096", NULL, NULL, "-", "[1,8192]", "OG_TYPE_INTEGER", NULL,
      PARAM_CHECKPOINT_GROUP_SIZE, EFFECT_REBOOT, CFG_INS, sql_verify_als_ckpt_group_size, NULL, NULL, NULL },
    ...
    { "ARCH_LOG_CHECK", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ARCH_LOG_CHECK, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "ENABLE_NESTLOOP_JOIN", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ENABLE_NESTLOOP_JOIN, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_enable_nestloop_join,
      sql_notify_als_bool, NULL },
    { "ENABLE_HASH_JOIN", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ENABLE_HASH_JOIN, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_enable_hash_join,
      sql_notify_als_bool, NULL },
    ...
    { "ENABLE_IDX_KEY_LEN_CHECK", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      ...
      sql_notify_als_bool, NULL },
    { "CBO", OG_TRUE, ATTR_NONE, "ON", NULL, NULL, "-", "ON", "OG_TYPE_VARCHAR", NULL, PARAM_CBO, EFFECT_IMMEDIATELY,
      CFG_INS, sql_verify_als_onoff, sql_notify_als_cbo, sql_notify_als_onoff, NULL },
    ...
    { "CTRLLOG_BACKUP_LEVEL", OG_TRUE, ATTR_NONE, "NONE", NULL, NULL, "-", "NONE,TYPICAL,FULL", "OG_TYPE_VARCHAR", NULL,
      PARAM_CTRLLOG_BACKUP_LEVEL, EFFECT_REBOOT, CFG_INS, sql_verify_als_ctrllog_backup_level,
    ...
    { "MES_CPU_INFO", OG_TRUE, ATTR_NONE, "", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL, PARAM_MES_CPU_INFO,
      EFFECT_REBOOT, CFG_INS, sql_verify_als_cpu_inf_str, NULL, NULL, NULL },
    ...
    { "OGSTORE_INST_PATH", OG_TRUE, ATTR_NONE, "UDS:/tmp/.ogstore_unix_d_socket", NULL, NULL, "-", "-",
      "OG_TYPE_VARCHAR", NULL, PARAM_OGSTORE_INST_PATH, EFFECT_REBOOT, CFG_INS, sql_verify_als_uds_file_path, NULL,
      NULL, NULL },
    { "INTERCONNECT_BY_PROFILE", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_INTERCONNECT_BY_PROFILE, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool,
      sql_notify_als_bool, NULL },
    ...
    { "MES_CRC_CHECK_SWITCH", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_MES_CRC_CHECK_SWITCH, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "OG_GDV_SQL_SESS_TMOUT", OG_TRUE, ATTR_NONE, "10", NULL, NULL, "-", "[0, 1000]", "OG_TYPE_INTEGER", NULL,
      PARAM_GDV_SQL_SESS_TMOUT, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_uint32, sql_notify_als_gdv_sess_tmout, NULL,
      NULL },
    ...
    { "RCY_NODE_READ_BUF_SIZE", OG_TRUE, ATTR_NONE, "4", NULL, NULL, "-", "[2,10]", "OG_TYPE_INTEGER", NULL,
      PARAM_RCY_NODE_READ_BUF_SIZE, EFFECT_REBOOT, CFG_INS, sql_verify_rcy_read_buf_size, NULL, NULL, NULL },
    { "DTC_RCY_PARAL_BUF_LIST_SIZE", OG_TRUE, ATTR_NONE, "256", NULL, NULL, "-", "[2,256]", "OG_TYPE_INTEGER", NULL,
      PARAM_DTC_RCY_PARAL_BUF_LIST_SIZE, EFFECT_REBOOT, CFG_INS, sql_verify_dtc_rcy_paral_buf_list_size, NULL, NULL,
      NULL },
    ...
    { "CPU_GROUP_INFO", OG_TRUE, ATTR_NONE, "0", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL, PARAM_CPU_GROUP_INFO,
      EFFECT_REBOOT, CFG_INS, sql_verify_als_cpu_inf_str, NULL, NULL, NULL },

    /* deadlock */
    { "_DEADLOCK_DETECT_INTERVAL", OG_TRUE, ATTR_NONE, "1000", NULL, NULL, "-", "1,10,100,1000", "OG_TYPE_INTEGER",
      NULL, PARAM_DEADLOCK_DETECT_INTERVAL, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_deadlock_detect_interval,
      sql_notify_als_deadlock_detect_interval, NULL, NULL },
    ...
    { "SHARED_PATH", OG_TRUE, ATTR_READONLY, "", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL, PARAM_SHARED_PATH,
      EFFECT_REBOOT, CFG_DB, sql_verify_als_comm, NULL, NULL, NULL },
    /* dbstor */
    { "ENABLE_DBSTOR", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ENABLE_DBSTOR, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "DBSTOR_NAMESPACE", OG_TRUE, ATTR_NONE, "", NULL, NULL, "-", "-", "OG_TYPE_VARCHAR", NULL, PARAM_DBSTOR_NAMESPACE,
      EFFECT_REBOOT, CFG_INS, sql_verify_als_comm, NULL, NULL, NULL },
    ...
    { "PAGE_CLEAN_MODE", OG_TRUE, ATTR_NONE, "SINGLE", NULL, NULL, "-", "SINGLE,ALL", "OG_TYPE_VARCHAR", NULL,
      PARAM_PAGE_CLEAN_MODE, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_page_clean_mode,
      sql_notify_als_page_clean_mode, NULL, NULL },
    { "ENABLE_DBSTOR_BATCH_FLUSH", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      ...
      sql_notify_als_bool, NULL },
    { "CLUSTER_ID", OG_TRUE, ATTR_NONE, "0", NULL, NULL, "-", "[0,65535]", "OG_TYPE_INTEGER", NULL, PARAM_CLUSTER_ID,
      EFFECT_REBOOT, CFG_INS, sql_verify_als_uint32, NULL, NULL, NULL },
    { "BACKUP_RETRY", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_BACKUP_RETRY, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    { "BATCH_FLUSH_CAPACITY", OG_TRUE, ATTR_NONE, "160", NULL, NULL, "-", "[1,4096]", "OG_TYPE_INTEGER", NULL,
      PARAM_BATCH_FLUSH_CAPACITY, EFFECT_REBOOT, CFG_INS, sql_verify_als_batch_flush_capacity, NULL, NULL, NULL },
    { "ENABLE_HWN_CHANGE", OG_TRUE, ATTR_READONLY, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ENABLE_HWN_CHANGE, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "MES_SSL_SWITCH", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_MES_SSL_SWITCH, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "ENABLE_SYS_CRC_CHECK", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_ENABLE_SYS_CRC_CHECK, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_enable_crc_check,
      sql_notify_als_bool, NULL },
    { "CLUSTER_NO_CMS", OG_TRUE, ATTR_READONLY, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_CLUSTER_NO_CMS, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    { "OG_CLUSTER_STRICT_CHECK", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_OG_CLUSTER_STRICT_CHECK, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_bool,
      sql_notify_als_bool, NULL },
    { "DRC_IN_REFORMER_MODE", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_DRC_IN_REFORMER_MODE, EFFECT_REBOOT, CFG_INS, sql_verify_als_bool, sql_notify_als_bool, sql_notify_als_bool,
      NULL },
    ...
    { "USE_BISON_PARSER", OG_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "OG_TYPE_BOOLEAN", NULL,
      PARAM_USE_BISON_PARSER, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_use_bison_parser,
      sql_notify_als_bool, NULL },
    // EXPLAIN
