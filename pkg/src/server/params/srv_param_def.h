...
typedef enum en_param_global {
    ...
    PARAM__ENABLE_REMOTE_DISTRIBUTE_LOCK,
    PARAM__ENABLE_UBSMEM,
    PARAM__UB_PAGE_HOT_THRESHOLD,
    PARAM__UB_PAGE_HOT_TIMEOUT,
    PARAM__UB_GBP_LOCK_TIMEOUT_MS,
    PARAM__UB_GBP_LOCK_DEBUG,
    PARAM_UBS_CLUSTER_HOSTS,
