...
typedef enum en_param_global {
    ...
    PARAM_UNDO_PERF_PREALLOC,
    PARAM_UNDO_PREALLOC_PAGES,
    ...
    PARAM_RBP_IP,
    PARAM_RBP_PORT,
    PARAM_LOCAL_RBP_HOST,
    PARAM_USE_RBP,
    PARAM_RBP_FOR_RECOVERY,
    PARAM_RBP_RT_ANALYSIS,
    PARAM_RBP_RT_PARSE_WORKERS,
    PARAM_RBP_RT_PAGE_OWNER_WORKERS,
    PARAM_RBP_ASSEMBLE_MAX_SCAN,
    PARAM_PLAN_DISPLAY_FORMAT,
    PARAM_SHOW_EXPLAIN_PREDICATE,
    PARAM_ENABLE_QUICK_CKPT,
    PARAM_ENABLE_PARA_LOG_FLUSH,
    PARAM_ENABLE_PARA_LOG_DFX,
    PARAM_CEIL,
} param_global_t;
