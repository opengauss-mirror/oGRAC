...
cms_cmd_def_t    g_cms_cmd_defs[] = {
    ...
    {{"diskreadonly", "-show"}, cms_disk_readonly, "display disk usage and write protection configuration."},
    {{"diskreadonly", "-recover-now"}, cms_disk_readonly, "disable disk write protection immediately."},
    ...
    {{"diskreadonly", "-set", "*[ITEM]", "*[VALUE]"}, cms_disk_readonly,
        "set disk write protection configuration."},
