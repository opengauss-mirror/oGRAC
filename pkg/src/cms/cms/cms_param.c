...
config_item_t g_cms_params[] = {
    ...
    { "_DISK_DETECT_FILE", OG_TRUE, ATTR_NONE, "", NULL, NULL, "-", "-", "OG_TYPE_INTEGER", NULL, 0, EFFECT_REBOOT,
      CFG_INS, NULL, NULL },
    { "_DISK_USAGE_CHECK_INTERVAL", OG_TRUE, ATTR_NONE, "30", NULL, NULL, "-", "[5,3600]", "OG_TYPE_INTEGER", NULL, 0,
      EFFECT_REBOOT, CFG_INS, NULL, NULL },
    { "_DISK_USAGE_THRESHOLD", OG_TRUE, ATTR_NONE, "85", NULL, NULL, "-", "[1,100]", "OG_TYPE_INTEGER", NULL, 0,
      EFFECT_REBOOT, CFG_INS, NULL, NULL },
    { "_DISK_USAGE_PROTECT_ENABLE", OG_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "-", "OG_TYPE_BOOLEAN", NULL, 0,
      EFFECT_REBOOT, CFG_INS, NULL, NULL },
    { "_DISK_USAGE_READONLY_COOLDOWN", OG_TRUE, ATTR_NONE, "120", NULL, NULL, "-", "[1,3600]", "OG_TYPE_INTEGER",
      NULL, 0, EFFECT_REBOOT, CFG_INS, NULL, NULL },
