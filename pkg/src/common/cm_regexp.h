...
typedef struct st_regexp_args {
    ...
    int32 subexpr;       // specifies which capture group of the pattern-expression is used to determine the positionwithin source-string to return, default is 0
