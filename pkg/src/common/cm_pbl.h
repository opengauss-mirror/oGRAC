...
#define OG_MAX_PBL_FILE_SIZE        SIZE_M(100)
#define OG_MIN_PBL_FILE_SIZE        SIZE_M(10)
#define OG_MAX_PBL_LINE_SIZE        (OG_PBL_PASSWD_MAX_LEN + OG_MAX_NAME_LEN + 1)

typedef struct st_pbl_entry {
    char user[OG_NAME_BUFFER_SIZE];
    SENSI_INFO char pwd[OG_PWD_BUFFER_SIZE];
} pbl_entry_t;
