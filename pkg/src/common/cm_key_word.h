...
// 20000 is used for OG_TYPE_BASE in cm_defs.h
...
typedef enum en_key_wid {
    ...
    KEY_WORD_DATABASE,
    KEY_WORD_DATAFILE,
    KEY_WORD_DB,   /* unused add datafile */
    KEY_WORD_DEBUG,
    KEY_WORD_DECLARE,
    ...
    KEY_WORD_RENAME,
    KEY_WORD_REPAIR,
    KEY_WORD_REPAIR_COPYCTRL,
    KEY_WORD_REPAIR_PAGE,
    KEY_WORD_REPLACE,
