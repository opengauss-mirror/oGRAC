...
static const type_desc_t g_datatype_items[OG_MAX_DATATYPE_NUM] = {
    ...
    [OG_TYPE_I(OG_TYPE_NUMBER2)] = { OG_TYPE_NUMBER2, { (char *)"NUMBER2", 7 }, 1001 },
...
static const uint64 g_dest_cast_mask[OG_MAX_DATATYPE_NUM] = {
    ...
    [OG_TYPE_I(OG_TYPE_CLOB)] = OG_TYPE_MASK_STRING | OG_TYPE_MASK(OG_TYPE_CLOB) |
    OG_TYPE_MASK(OG_TYPE_IMAGE) | OG_TYPE_MASK_NUMERIC,
