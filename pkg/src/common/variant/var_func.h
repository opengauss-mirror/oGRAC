...
typedef struct st_var_func {
    ...
    uint32 pack_id; // package id,  buildin function is OG_INVALID_32
...
typedef struct st_var_udo {
    bool8  name_sensitive; // OG_TRUE: name like "xxx", OG_FALSE: name like xxx
    bool8  pack_sensitive; // OG_TRUE: pack like "xxx", OG_FALSE: pack like xxx
    bool8  user_explicit;  // OG_TRUE: user is explicitly specified
    uint8  unused;
