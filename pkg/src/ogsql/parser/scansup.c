 ...
 */
char* downcase_truncate_identifier(const char* ident, int len, bool8 warn)
{
    char* result = NULL;
    int i;
    bool8 enc_is_single_byte = OG_FALSE;

    result = (char*)malloc(len + 1);
    enc_is_single_byte = OG_TRUE;
...
char* upcase_truncate_identifier(const char* ident, int len, bool8 warn)
{
    char* result = NULL;
    int i;
    bool8 enc_is_single_byte = OG_FALSE;
