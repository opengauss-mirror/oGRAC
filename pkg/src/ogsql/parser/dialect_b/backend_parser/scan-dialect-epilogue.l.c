...
core_yyscan_t b_scanner_init(const sql_text_t *sql,
                                   ...
                                   sql_stmt_t *stmt)
{
    ...
    b_core_yyset_extra(yyext, scanner);
 ...
 */
void b_scanner_finish(core_yyscan_t yyscanner)
{
...
void* b_core_yyalloc(yy_size_t bytes, core_yyscan_t yyscanner)
{
...
void* b_core_yyrealloc(void *ptr, yy_size_t bytes, core_yyscan_t yyscanner)
{
...
void b_core_yyfree(void *ptr, core_yyscan_t yyscanner)
{
    core_yyfree(ptr, yyscanner);
}

#define core_yyset_extra b_core_yyset_extra
