 ...
 * -------------------------------------------------------------------------
 *
 * ogbackup_archivelog.h
 *
 *
 * IDENTIFICATION
 * src/utils/ogbackup/ogbackup_archivelog.h
 *
 * -------------------------------------------------------------------------
 */

#ifndef OGRACDB_OGBACKUP_ARCHIVELOG_H
#define OGRACDB_OGBACKUP_ARCHIVELOG_H
#include <getopt.h>
#include "cm_defs.h"
...
#endif  // OGRACDB_OGBACKUP_ARCHIVELOG_H
