...
void dc_revoke_objpriv_from_role_by_id(dc_context_t *ogx, dc_role_t *role, dc_obj_priv_item *priv_item,
                                       uint32 privid);
...
status_t dc_alloc_objpriv_entry(dc_context_t *ogx, dc_obj_priv_t *obj_privs, memory_context_t *memory,
                                uint32 owner_uid, text_t *obj_name, uint32 obj_type, dc_obj_priv_entry_t **dc_entry);
