 ...
 *
 * IDENTIFICATION
 * src/kernel/catalog/knl_privilege.h
 *
 * -------------------------------------------------------------------------
 */
...
#define DC_SET_OBJ_PRIV(privs, id) OG_BIT_SET((privs), OG_GET_MASK(id))
#define DC_GET_OBJ_PRIV(privs, id) OG_BIT_TEST((privs), OG_GET_MASK(id))
#define DC_CLR_OBJ_PRIV(privs, id) OG_BIT_RESET(privs, OG_GET_MASK(id))
#define DC_HAS_OBJ_PRIV(privs, id) (DC_GET_OBJ_PRIV(privs, id) != 0)

#define DC_SET_OBJ_OPT(option, id) OG_BIT_SET((option), OG_GET_MASK(id))
#define DC_GET_OBJ_OPT(option, id) OG_BIT_TEST((option), OG_GET_MASK(id))
#define DC_CLR_OBJ_OPT(option, id) OG_BIT_RESET(option, OG_GET_MASK(id))
...
#define OG_MAX_GRANT_USERS ((KNL_LOGIC_LOG_BUF_SIZE - LOG_ENTRY_SIZE) / sizeof(rd_privs_t))
