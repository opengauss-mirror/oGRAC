...
knl_column_t g_sys_table_columns[] = {
    ...
    { 4,  "ORG_SCN",      0, SYS_TABLE_ID, OG_TYPE_BIGINT,    sizeof(uint64),  0,                         0, OG_FALSE, 0, { NULL, 0 } },  // scn when creating
    { 5,  "CHG_SCN",      0, SYS_TABLE_ID, OG_TYPE_BIGINT,    sizeof(uint64),  0,                         0, OG_FALSE, 0, { NULL, 0 } },  // ddl time
...
knl_column_t g_sys_index_columns[] = {
    ...
    { 5,  "SEQUENCE#",               0, SYS_INDEX_ID, OG_TYPE_BIGINT,    sizeof(uint64),      0,                         0,                         OG_FALSE, 0, { NULL, 0 } },  // scn when creating
...
knl_column_t g_sys_user_columns[] = {
    ...
    { 3,  "DATA_SPACE#", 0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // default tablespace
    { 4,  "TEMP_SPACE#", 0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // temporary space
    { 5,  "CTIME",       0, SYS_USER_ID, OG_TYPE_DATE,    sizeof(date_t),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // user account creation time
    { 6,  "PTIME",       0, SYS_USER_ID, OG_TYPE_DATE,    sizeof(date_t),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // pwd change time
    { 7,  "EXPTIME",     0, SYS_USER_ID, OG_TYPE_DATE,    sizeof(date_t),          0, 0, OG_TRUE,  0, { NULL, 0 } },  // actual pwd expiration time
    { 8,  "LTIME",       0, SYS_USER_ID, OG_TYPE_DATE,    sizeof(date_t),          0, 0, OG_TRUE,  0, { NULL, 0 } },  // time when account is locked
    { 9,  "PROFILE#",    0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // profile#
    { 10, "ASTATUS",     0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // status of the account. 0x00 = Open, 0x01 = Locked, 0x02 = Expired
    { 11, "LCOUNT",      0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // count of failed login attempts
    { 12, "OPTIONS",     0, SYS_USER_ID, OG_TYPE_RAW,     OG_SYS_OPT_LEN,          0, 0, OG_TRUE,  0, { NULL, 0 } },
    { 13, "TENANT_ID",   0, SYS_USER_ID, OG_TYPE_INTEGER, sizeof(uint32),          0, 0, OG_FALSE, 0, { NULL, 0 } },  // tenant id
};
...
static index_t g_sys_indexes[] = {
    ...
    { { 1, 1, 0, SYS_SPACE_ID, SYS_INDEX_ID, "IX_INDEX$002", 0, 0, { 0 }, OG_FALSE, OG_TRUE, INDEX_TYPE_BTREE, 3, { 0, 3, 1}, OG_INI_TRANS, CR_ROW, { 0 }, 0, OG_PCT_FREE, OG_FALSE, NULL, OG_MAX_KEY_SIZE } },
...
status_t db_write_systable(knl_session_t *session, knl_cursor_t *cursor, knl_table_desc_t *desc)
{
    ...
    (void)row_put_uint64(&ra, desc->serial_start);  // auto increment init value
