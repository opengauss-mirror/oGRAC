 ...
 *
 * IDENTIFICATION
 * src/kernel/catalog/knl_profile.h
 *
 * -------------------------------------------------------------------------
 */
...
#define MAX_PROFILE_SIZE  (OG_SHARED_PAGE_SIZE / sizeof(pointer_t))
#define PROFILE_HASH_SIZE (OG_SHARED_PAGE_SIZE / sizeof(bucket_t))
