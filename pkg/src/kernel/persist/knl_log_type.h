 ...
 *
 * IDENTIFICATION
 * src/kernel/persist/knl_log_type.h
 *
 * -------------------------------------------------------------------------
 */
...
typedef enum en_log_type {
    ...
    RD_SPC_SET_AUTOEXTEND = LOG_TYPE_SPACE + 19,
    RD_SPC_SET_FLAG = LOG_TYPE_SPACE + 20,
    RD_SPC_RENAME_SPACE = LOG_TYPE_SPACE + 21,
    RD_SPC_CHANGE_AUTOEXTEND = LOG_TYPE_SPACE + 22,
    ...
    RD_UNDO_NOLOG_WRITE = LOG_TYPE_UNDO + 12,
    ...
    RD_BTREE_RECYCLE_PAGE = LOG_TYPE_BTREE + 22,
    RD_BTREE_CONCAT_DEL_PAGE = LOG_TYPE_BTREE + 23,
    ...
    RD_LOB_CHANGE_PAGE_FREE = LOG_TYPE_LOB + 9,
    ...
    RD_LOGIC_REP_ALL_DDL = LOG_TYPE_LREP + 4,
...
typedef enum st_logic_op {
    ...
    RD_SPC_SET_AUTOEXTEND_OGRAC = 16,
    RD_SPC_RENAME_SPACE_OGRAC = 17,
    RD_DATAFILE_EXTENT_SIZE = 18,
    RD_CREATE_SEQUENCE = 19,
    RD_DROP_SEQUENCE = 20,
    RD_ALTER_SEQUENCE = 21,
    RD_SPC_CHANGE_AUTOEXTEND_OGRAC = 22,
    RD_CREATE_PROFILE = 23,
    RD_ALTER_PROFILE = 24,
    RD_DROP_PROFILE = 25,
    RD_SPC_SET_FLAG_OGRAC = 26,
    ...
    RD_SPC_CREATE_SPACE_OGRAC = 47,
    RD_SPC_REMOVE_SPACE_OGRAC = 48,
    RD_SPC_CREATE_DATAFILE_OGRAC = 49,
    RD_SPC_REMOVE_DATAFILE_OGRAC = 50,
    RD_SPC_EXTEND_DATAFILE_OGRAC = 51,
    RD_SPC_TRUNCATE_DATAFILE_OGRAC = 52,
    RD_CREATE_HEAP_ENTRY = 53,
    RD_CREATE_BTREE_ENTRY = 54,
    RD_CREATE_LOB_ENTRY = 55,
    RD_INVALIDATE_DC = 56,
...
typedef enum st_logic_op_class {
    LOGIC_OP_START = 0,
    LOGIC_OP_VIEW = 1,
    LOGIC_OP_SEQUNCE = 2,
    LOGIC_OP_SYNONYM = 3,
