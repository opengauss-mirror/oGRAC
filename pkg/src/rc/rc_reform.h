...
typedef status_t (*rc_cb_write_protect_switch)(knl_session_t *session, const CmsWriteProtectSwitchCtxT *ctx);
...
typedef struct st_reform_callback {
    ...
    rc_cb_write_protect_switch rc_write_protect_switch;
} reform_callback_t;
