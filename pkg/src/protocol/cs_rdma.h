...
/* rscoket ping is very low and rbp start at most 16 rsocket connections, so set buffer size small */
...
#define OG_RSOCKET_KEEP_INTERVAL        (uint32)1
#define OG_RSOCKET_KEEP_COUNT           (uint32)2
