...
#define CS_CMD_FREE_STMT     (uint8)2 /* og_alloc_stmt() command is included in CS_CMD_PREPARE requestion */
...
typedef enum en_client_kind {
    ...
    CLIENT_KIND_CTCONN_GENERIC = 1, /* for the most common program which use the ogconn library */
    CLIENT_KIND_JDBC = 2,
    CLIENT_KIND_OGSQL = 3,
...
#define CS_OGSQL_IN_ALTPWD 0x0020
...
#define OG_COLUMN_FLAG_NULLABLE       0x01
#define OG_COLUMN_FLAG_AUTO_INCREMENT 0x02
