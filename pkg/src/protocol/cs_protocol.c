...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_prepare_ack_t), (void **)prepare_ack));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_param_def_t), (void **)param_def));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_param_def_new_t), (void **)param_def));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_column_def_t), (void **)column_def));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_outparam_def_t), (void **)o_def));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_execute_ack_t), (void **)exec_ack));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_final_column_def_t), (void **)column_def));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(cs_fetch_ack_t), (void **)fetch_ack));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
...
{
    OG_RETURN_IFERR(cs_get_data(pack, sizeof(lob_read_ack_t), (void **)lob_read_ack));
    if (CS_DIFFERENT_ENDIAN(pack->options)) {
