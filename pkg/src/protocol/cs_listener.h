...
typedef struct st_uds_lsnr {
    ...
    int epoll_fd;
    lsnr_status_t status;
    char names[OG_MAX_LSNR_HOST_COUNT][OG_UNIX_PATH_MAX];
    socket_t socks[OG_MAX_LSNR_HOST_COUNT];
    uint32 permissions;
